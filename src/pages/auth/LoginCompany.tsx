    ...
    <div className="min-h-screen bg-[#FBF9FF] flex items-center justify-center relative overflow-hidden animate-fadeIn">
      ...
      <div className="w-full max-w-[950px] grid grid-cols-1 lg:grid-cols-2 gap-8 px-6">
        ...
        <div className="bg-white border-2 border-black shadow-[8px_8px_0px_black] p-6 relative">
          ...
          <span className="bg-[#6BCF7F] text-black text-xs px-3 py-1 inline-block mb-6 border-2 border-black">
            FOR COMPANY
          </span>
          ...
          <p className="text-gray-700 mb-8">
            Create AI-powered virtual internships. Discover skilled candidates.
            Build your team.
          </p>
          ...
          <div className="space-y-6">
            <Feature
              ...
              text="AI finds the perfect candidates"
            />
            <Feature
              color="bg-[#6BCF7F]"
            ...
            <Feature
              ...
              text="Pre-vetted skilled candidates"
            />
          </div>
        </div>
        ...
        <div className="bg-white border-2 border-black shadow-[8px_8px_0px_black] p-6">
          ...
          <h2 className="text-2xl font-bold mb-6">Company Login</h2>

          <div className="border-2 border-black p-3 flex justify-between items-center mb-6">
            <span className="text-sm">Looking for student access?</span>
            <Link
              to="/login/student"
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#6BCF7F] text-white py-3 border-2 border-black shadow-[4px_4px_0px_black] hover:translate-y-[2px] hover:shadow-none transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
